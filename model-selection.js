document.addEventListener('DOMContentLoaded', () => {
  ...
  tabModels.addEventListener('click', () => {
    ...
    // Update page title
    if (pageTitle) pageTitle.textContent = 'Models';
  });
  ...
  tabSettings.addEventListener('click', () => {
    ...
    tabSettingsMain.classList.add('active');
    tabSettingsMain.classList.remove('border-transparent');
    tabSettingsPrompt.classList.remove('active');
  ...
  tabSettingsPrompt.addEventListener('click', () => {
    tabSettingsPrompt.classList.add("active");
    tabSettingsPrompt.classList.remove("active");
    tabSettingsMain.classList.remove("active");
    tabSettingsMain.classList.add("active");
...
async function loadPrompt() {
  ...
  if (saveApikeyBtn) {
    saveApikeyBtn.addEventListener('click', async () => {
      ...
      if (chrome && chrome.storage && chrome.storage.local) {
        const encrypted = await (window._extEncryptApiKey ? window._extEncryptApiKey(apiKeyValue) : apiKeyValue);
